    ...
    public function getImportableEntities(): array
    {
        return [
            'products' => [
                ...
                'optional_columns' => ['sku', 'barcode', 'default_price', 'cost', 'min_stock', 'is_active', 'category_id', 'module_id'],
                'validation_rules' => [
            ...
            'customers' => [
                'name' => __('Customers'),
                'required_columns' => ['name'],
                'optional_columns' => ['email', 'phone', 'address', 'city', 'country', 'tax_id', 'credit_limit'],
                'validation_rules' => [
                    'name' => 'required|string|max:255',
            ...
            'suppliers' => [
                'name' => __('Suppliers'),
                'required_columns' => ['name'],
                'optional_columns' => ['email', 'phone', 'address', 'city', 'country', 'tax_id', 'payment_terms'],
                'validation_rules' => [
                    'name' => 'required|string|max:255',
                    'email' => 'nullable|email|max:255',
                    'phone' => 'nullable|string|max:50',
